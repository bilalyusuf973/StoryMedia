...
const Homepage = () => {
  ...
  <>
    ...
    <div className="div1 w-full h-full flex sm:justify-center items-center overflow-y-auto overflow-x-auto">
      <div className='div11 p-8 lg:w-full flex flex-col lg:flex-row justify-center lg:justify-around items-center'>
        <div className='div111 mr-auto lg:mr-0'>
          <img src="brandIcon.png" alt="Icon" className='w-[64px] h-[64px] lg:w-[320px] lg:h-[320px]' onClick={() => router.push("/home")}/>
        </div>
        <div className='div112 w-fit'>
          <div className='div1121 flex items-center flex-wrap text-4xl lg:text-5xl font-bold mb-12 mt-7'>
            <span className='my-1'>Welcome to</span>
            <span className='my-1'>&nbsp;NetVibes</span>
          </div>
          <div className='div1122 text-2xl lg:text-3xl font-semibold mb-3'>Join today.</div>
          <div className='div1123 w-[300px]'>
            <div className='div11231 cursor-pointer content-center bg-white hover:bg-[#efefef] text-[#272727d3] text-[15px] font-semibold rounded-[25px] my-3 p-2 border border-gray-400'>
            ...
            <div className='div11232 cursor-pointer content-center bg-white hover:bg-[#d1d1d1] text-[#272727] text-[15px] font-semibold rounded-[25px] my-3 p-2 border border-gray-400'>
            ...
            <div className='div11233 content-center'>
