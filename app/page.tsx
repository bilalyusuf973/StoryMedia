  ...
  return (
    <>
      ...
      <div className="absolute top-0 bottom-0 left-0 right-0 flex p-8 justify-center lg:justify-around items-center flex-col lg:flex-row">
        <div className=''>
          <img src="brandIcon.png" alt="Icon" className='w-[50px] h-[50px] lg:w-[320px] lg:h-[320px]' onClick={() => router.push("/home")}/>
        </div>
        <div className='flex flex-col'>
          <div className='content-center flex-wrap text-4xl md:text-5xl font-bold mb-12 mt-7'>
            <span className='my-1'>Welcome to</span>
            <span className='my-1'>&nbsp;NetVibes</span>
          </div>
          <div className='text-2xl md:text-3xl font-semibold mb-3'>Join today.</div>
