    ...
    <GlobalLayout>
        <MiddleBar>
          {!isLoading && data?.user ? <div className='w-full flex flex-col'>
            <BackBtnHeader showBackArrow={true} label={data.user.userInfo.name}/>
            <div className=''>
              <div className="user">
                ...
                <div className='p-3'>
                  <div className='flex items-center justify-between h-10'>
                    <div className="mb-16">
                      <Avatar username={data.user.userInfo.username} hasBorder image={data.user.userInfo.profileImage}/>
                    </div>
                  ...
                  <div className='px-2 md:pt-4 flex flex-col cursor-pointer'>
                    <Name name={data.user.userInfo.name} sx='text-[18px] leading-[22px]'/>
                    <UserName username={data.user.userInfo.username} sx='text-neutral-500 text-[15px]'/>
                  </div>
                  <div></div>
                </div>
              </div>
